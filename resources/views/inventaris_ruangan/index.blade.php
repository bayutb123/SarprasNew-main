...
@section('main-content')
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">Inventaris Ruangan</h1>

    <!-- Main Content goes here -->

    <a href="{{ route('inventory.create') }}" class="btn btn-primary mb-3 mr-3">Tambah Inventaris Ruangan</a>
    <a href="{{ route('inventory_ruangan.cetak_pdf') }}" class="btn btn-danger mb-3">Cetak Pdf</a>
                ...
                <table class="table table-bordered table-stripped">
                    <thead>
                        ...
                        <tr>
                            ...
                            <th rowspan="2" width="10%">Rasio</th>
